...
#### 🛒 [Retail Sales Analytics — Azure Data Engineering](https://github.com/rajashekhar9390)
End-to-end pipeline on Medallion Architecture: raw retail sales data ingested via ADF, transformed in Databricks with PySpark, stored as Delta Lake tables, and visualized in Power BI.
`Azure Data Factory` `Azure Databricks` `ADLS Gen2` `PySpark` `Delta Lake` `Azure SQL Database` `Power BI`

#### 🚦 [GIS Road Asset & Traffic Analytics Platform](https://github.com/rajashekhar9390)
Domain-driven platform combining GIS road asset data with traffic analytics — ADF for orchestration, Databricks/PySpark for transformation, Power BI for reporting. Built on real GIS engineering domain knowledge.
`Azure Data Factory` `Azure Databricks` `ADLS Gen2` `PySpark` `Delta Lake` `Power BI`

> 🔗 Full code, pipeline configs, and docs in the pinned repos on my [GitHub profile](https://github.com/rajashekhar9390)
...
<p align="center">
  <img height="165" src="https://github-readme-stats.vercel.app/api?username=rajashekhar9390&show_icons=true&theme=default&count_private=true" />
  <img height="165" src="https://github-readme-streak-stats.herokuapp.com/?user=rajashekhar9390&theme=default" />
</p>
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=rajashekhar9390&layout=compact&theme=default" />
</p>
...
Advanced Azure Data Engineering · Apache Spark Performance Optimization · Microsoft Fabric · Azure DevOps for Data Engineering
...
<p align="center"><i>Thanks for visiting — always open to Azure Data Engineering opportunities and collaborations!</i></p>
